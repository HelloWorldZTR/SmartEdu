      ...
      <div class="text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            ...
            @click="retry"
            class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-primary-600 bg-primary-100 hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors"
          >
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="errorType === 'server'" class="mt-8 text-sm text-gray-500">
          ...
          <p class="mt-2">
            <a href="mailto:support@smartedu.com" class="text-primary-600 hover:text-primary-500">
